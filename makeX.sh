...
sshpass -p "<----password---->" scp -r PikabuSettings.bundle root@192.168.1.106:/bootstrap/Library/PreferenceBundles
...
sshpass -p "<----password---->" scp Pikabu.dylib root@192.168.1.106:/bootstrap/Library/SBInject
cd ../../../
sshpass -p "<----password---->" ssh -l root 192.168.1.106 "killall 9 SpringBoard"
